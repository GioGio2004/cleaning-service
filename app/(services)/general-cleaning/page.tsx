...
const WHATSAPP_URL = "https://wa.me/995555123456?text=Hello!%20I%20would%20like%20to%20book%20a%20consultation%20for%20general%20cleaning.";

const SERVICE_BREAKDOWN = [
  {
    title: "1. Comprehensive Dusting & Prep",
    desc: "We systematically remove dust, cobwebs, and allergens from every corner, baseboard, and fixture, ensuring a pristine canvas for deep sanitization.",
  },
  {
    title: "2. Deep Mopping & Sanitizing",
    desc: "High-touch surfaces, countertops, and floors are thoroughly mopped and disinfected using premium, eco-safe products that eliminate bacteria.",
  },
  {
    title: "3. Trusted & Reliable Staff",
    desc: "Our highly vetted, professional cleaning staff treat your space with the utmost respect and confidentiality, delivering consistent, reliable results every time.",
  },
];

const BLOG_POSTS = [
  {
    title: "Daily Habits to Keep Your Home Spotless Between Cleanings",
    date: "May 22, 2026",
    img: "https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?q=80&w=900&auto=format&fit=crop",
    readTime: "5 min read"
  },
  {
    title: "The Invisible Germs: Why Office Sanitization Matters",
    date: "May 10, 2026",
    img: "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=900&auto=format&fit=crop",
    readTime: "7 min read"
  },
  {
    title: "Eco-Friendly Products for a Healthier Living Space",
    date: "April 29, 2026",
    ...
    <div ref={containerRef} className="relative min-h-screen bg-black text-slate-200">
      ...
      <section className="relative z-10 flex flex-col items-center justify-center min-h-[100dvh] px-6 text-center" aria-label="Hero">
        ...
        >
          ...
          <em className="italic text-white" style={{ fontStyle: "italic" }}>Tailored Plans.</em>
        </h1>

        <p className="hero-reveal mt-7 max-w-2xl text-lg leading-relaxed text-white/80 font-light">
          Comprehensive general cleaning focused on the details. From sweeping and sanitizing to deep mopping, we customize every visit to match your exact needs with our vetted, trusted professionals.
        </p>
        ...
        <div className="scroll-indicator absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 opacity-40">
          <span className="text-xs tracking-widest uppercase font-medium text-slate-200">Explore Structure</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', serif" }}
            >
              Reliability & <br /> Thoroughness
            </h2>
            <p className="text-base text-slate-400 font-light leading-relaxed mb-8">
              A clean environment begins with reliable people. We don't just dust and mop; we completely sanitize your environment using a highly trained crew that respects your privacy and works meticulously. Every cleaning plan is fully customizable to your schedule and requirements.
            </p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
            ...
            >
              Discuss a customized plan <ArrowRight className="w-4 h-4" />
            </a>
          </div>
          ...
          <div className="flex flex-col gap-8 relative before:absolute before:left-[19px] before:top-4 before:bottom-4 before:w-[2px] before:bg-white/10 hidden md:flex">
            {SERVICE_BREAKDOWN.map((step, idx) => (
      ...
      <section className="relative z-10 blog-section px-6 py-28 max-w-7xl mx-auto border-t border-white/10 bg-black/40">
        <div className="mb-16 flex flex-col items-center text-center gap-4">
          ...
          <p className="max-w-md text-base text-slate-400 font-light">
            Stay informed on the best practices for maintaining a sterile, welcoming, and organized environment.
          </p>
        </div>
      ...
      <footer className="relative z-10 footer-section px-6 py-32 text-center border-t border-white/10 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto flex flex-col items-center gap-8">
          <h2
            ...
            style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', serif" }}
          >
            Ready for a<br /> <em className="italic text-white" style={{ fontStyle: "italic" }}>Spotless Environment?</em>
          </h2>
          <p className="text-base text-slate-400 max-w-md font-light leading-relaxed">
            All general cleaning plans are highly customizable and rates are strictly negotiable based on the size of your space and frequency of visits.
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
